...
public final class IndexSettings {
     ...
     */
    public static final Setting<String> INDEX_SEARCH_BOOST_TIER_SETTING = Setting.simpleString("index.search.boost_tier", "", value -> {
        if (value.isEmpty() == false && value.equals("boosted") == false && value.equals("unboosted") == false) {
            throw new IllegalArgumentException(
                "[index.search.boost_tier] must be one of [boosted, unboosted] or empty, but was [" + value + "]"
            );
        }
