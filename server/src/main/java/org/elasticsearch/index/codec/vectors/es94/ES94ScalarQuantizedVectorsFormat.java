...
public class ES94ScalarQuantizedVectorsFormat extends FlatVectorsFormat {
    ...
    public ES94ScalarQuantizedVectorsFormat() {
        this(DenseVectorFieldMapper.ElementType.FLOAT, 7);
    }
    ...
    public ES94ScalarQuantizedVectorsFormat(DenseVectorFieldMapper.ElementType elementType, int bits) {
        super(NAME);
    ...
    public FlatVectorsReader fieldsReader(SegmentReadState state) throws IOException {
        return new ESQuantizedVectorsReader(state, rawVectorFormat.fieldsReader(rescoreOnly(state)), flatVectorScorer);
    }
