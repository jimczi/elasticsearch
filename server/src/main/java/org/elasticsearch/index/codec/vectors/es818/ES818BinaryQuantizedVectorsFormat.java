...
public class ES818BinaryQuantizedVectorsFormat extends AbstractFlatVectorsFormat {
    ...
    static final FlatVectorsFormat rawVectorFormat = new Lucene99FlatVectorsFormat(FlatVectorScorerUtil.getLucene99FlatVectorsScorer());
    ...
    public FlatVectorsReader fieldsReader(SegmentReadState state) throws IOException {
        return new ES818BinaryQuantizedVectorsReader(state, rawVectorFormat.fieldsReader(rescoreOnly(state)), scorer);
    }
