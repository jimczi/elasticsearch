 ...
 */
abstract class ShardActionListener<T extends SearchPhaseResult> implements ActionListener<T> {

    final int requestIndex;
    final SearchShardTarget searchShardTarget;

    protected ShardActionListener(SearchShardTarget searchShardTarget,
                                  int shardIndex) {
