...
public class IndicesServiceBuilder {
    ...
    QueryRewriteInterceptor queryInterceptor = null;
    ...
    public IndicesService build() {
        ...
        var interceptors = pluginsService.filterPlugins(SearchPlugin.class)
            .map(SearchPlugin::getQueryInterceptors)
            .flatMap(List::stream)
            .toList();
        queryInterceptor = QueryRewriteInterceptor.multi(interceptors);
