...
public final class ClusterSettings extends AbstractScopedSettings {
    ...
    public static final Set<Setting<?>> BUILT_IN_CLUSTER_SETTINGS = Set.of(
        ...
        SearchService.SEARCH_ADMISSION_CONTROL_SLOTS_PER_THREAD,
        SearchService.SEARCH_ADMISSION_CONTROL_MAX_QUEUE_LENGTH,
        SearchService.SEARCH_ADMISSION_CONTROL_ACQUIRE_TIMEOUT,
        SearchService.SEARCH_ADMISSION_CONTROL_RECLAIM_MIN_AGE,
        SearchService.SEARCH_ADMISSION_CONTROL_MEMORY_LIMIT,
        SearchService.SEARCH_ADMISSION_CONTROL_QUERY_MEMORY,
        SearchService.SEARCH_ADMISSION_CONTROL_BOOSTED_SLOT_FLOOR,
        SearchService.SEARCH_ADMISSION_CONTROL_UNBOOSTED_SLOT_FLOOR,
        SearchService.SEARCH_ADMISSION_CONTROL_SYSTEM_SLOT_FLOOR,
        SearchService.SEARCH_ADMISSION_CONTROL_LANE_STRATEGY,
        SearchService.SEARCH_ADMISSION_CONTROL_COORDINATOR_ENABLED,
        SearchService.SEARCH_ADMISSION_CONTROL_COORDINATOR_ACCEPT_TIMEOUT,
        SearchService.SEARCH_ADMISSION_CONTROL_COORDINATOR_RETRY_INTERVAL,
        SearchService.SEARCH_ADMISSION_CONTROL_COORDINATOR_MAX_QUEUED,
