...
/**
 * Resolves {@link SkipIndex} implementations by stable {@code getName()} on read.
 * Lucene-style {@link NamedSPILoader} pattern. Names registered through
 * {@code META-INF/services/org.elasticsearch.columnar.encoder.SkipIndex}.
 *
 ...
 */
public final class SkipIndexRegistry {

    private static final class Holder {
        static final NamedSPILoader<SkipIndex> LOADER = new NamedSPILoader<>(SkipIndex.class);
    }

    private SkipIndexRegistry() {}

    public static SkipIndex forName(String name) {
