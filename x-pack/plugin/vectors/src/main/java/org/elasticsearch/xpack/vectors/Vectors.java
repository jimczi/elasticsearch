...
import org.elasticsearch.xpack.vectors.query.NearestNeighborQueryBuilder;
...
public class Vectors extends Plugin implements MapperPlugin, ActionPlugin, SearchPlugin {
    ...
    public List<QuerySpec<?>> getQueries() {
        return Collections.singletonList(
            new QuerySpec<>(NearestNeighborQueryBuilder.NAME, NearestNeighborQueryBuilder::new, NearestNeighborQueryBuilder::fromXContent)
        );
    }
}
